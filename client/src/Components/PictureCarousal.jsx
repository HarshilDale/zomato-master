    ...
    <>
      <div className="w-full h-64 relative px-4 overflow-hidden">
        <div className="w-full h-full relative">
          <img
            src="https://b.zmtcdn.com/data/pictures/chains/7/2600007/7ed7d7ab943ac8aecfa3fd500e63644d_featured_v2.jpg?fit=around|771.75:416.25&crop=771.75:416.25;*,*"
            alt="food"
        ...
        <div className="absolute w-full left-8 bottom-2 text-white">
          <h4 className="z-10">Indore Special</h4>
